...
namespace ReactDesigner
{
    ...
    /// html.html|{903A0B92-9903-4C1F-9338-56A4F696AD1A}|#106|80|#109|{903A0B92-9903-4C1F-9338-56A4F696AD1A}|401|0|#107
    ///
    /// The fields in order are as follows:-
    ///    - html.html - our empty html file
    ///    - {903A0B92-9903-4C1F-9338-56A4F696AD1A} - our Editor package guid
    ...
    ///    - {903A0B92-9903-4C1F-9338-56A4F696AD1A} - resource dll string (we don't use this)
    ///    - 401 - the ID of our icon
    ///    - 0 - various flags (we don't use this - see vsshell.idl)
    ///    - #107 - the default file name "HtmlFile.html"
    /// </remarks>
