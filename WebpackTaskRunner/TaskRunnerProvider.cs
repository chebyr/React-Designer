...
namespace WebPackTaskRunner
{
    ...
    class TaskRunnerProvider : ITaskRunner
    {
        ...
        private void InitializeTaskRunnerOptions()
        {
        ...
        private ITaskRunnerNode LoadHierarchy(string configPath)
        {
            ...
            ITaskRunnerNode root = new TaskNode("NPM Task Runner", false, isNpm);
        ...
        private void SetRootNodeIcon(string cliCommandName) =>
            _icon = new BitmapImage(new Uri($@"pack://application:,,,/TaskRunner;component/Resources/{cliCommandName}.png"));
    }
}
